...
class TestRegistry:
    ...
    def get_tests_by_category(self, category: str) -> List[TestMetadata]:
        """Get all tests in a specific category"""
        return [test for test in self._registry.values() if test.category == category]

    def get_tests_by_suite(self, suite: str) -> List[TestMetadata]:
        """Get all tests in a specific suite"""
        return [test for test in self._registry.values() if test.suite == suite]

    def get_tests_by_platform(self, platform: str) -> List[TestMetadata]:
    ...
    def get_tests_by_priority(self, priority: str) -> List[TestMetadata]:
...
def get_test_registry() -> TestRegistry:
    ...
    if _registry_instance is None:
        _registry_instance = TestRegistry()
