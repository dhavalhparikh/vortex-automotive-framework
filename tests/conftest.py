...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "all_platforms: Tests that run on all platforms")
    config.addinivalue_line("markers", "platform_mock_platform: Tests for mock platform")
    config.addinivalue_line("markers", "platform_ecu_platform_a: Tests for ECU platform A")
    config.addinivalue_line("markers", "platform_ecu_platform_b: Tests for ECU platform B")
    ...
    config.addinivalue_line("markers", "mock_adapter: Mock adapter tests")
    config.addinivalue_line("markers", "cli_tests: CLI tests")
    config.addinivalue_line("markers", "spi_test: SPI tests")
